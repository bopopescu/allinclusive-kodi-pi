...
### Plugin Settings ###
def ps(x):
	if (x=='_addon_id') or (x=='addon_id') or (x=='_plugin_id') or (x=='plugin_id'): return 'plugin.video.filmehd.net'
	try: 
		return {
			'__plugin__': 					"FilmeHD.net"
			...
			,'_addon_path_art': 		"arte"
			,'_database_name': 			"filmehd"
			,'default_art_ext': 		'.png'
